package ru.akhitev.seng.droid.average.term.logic.calculator;
...
public class ReportCalculator {
    ...
    private final LocalDate bottomBorder;

    public ReportCalculator(List<CandidateValue> baseTestData, LocalDate bottomBorder) {
    ...
    private Double daysBetween(CandidateValue candidate) {
        long hours = Duration.between(candidate.groupDate().atStartOfDay(), candidate.startDate().atStartOfDay()).toHours();
